...
export JOB_AGENT_S3_BUCKET="${JOB_AGENT_S3_BUCKET:-${S3_UPLOAD_BUCKET}}"
...
export JOB_AGENT_PUBLIC_BASE_URL="${JOB_AGENT_PUBLIC_BASE_URL:-}"
export JOB_AGENT_DOMAIN_NAME="${JOB_AGENT_DOMAIN_NAME:-}"
export JOB_AGENT_ACM_CERTIFICATE_ARN="${JOB_AGENT_ACM_CERTIFICATE_ARN:-}"
